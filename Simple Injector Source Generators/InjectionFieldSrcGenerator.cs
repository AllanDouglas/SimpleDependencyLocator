...
namespace SimpleInject.SourceGenerators
{
    ...
    {
        private const string GENERATED_FIELD_NAMESPACE = "GeneratedFields";
        private const string INJECTION_FIELD_NAMESPACE = "Injector";
            ...
            List<INamedTypeSymbol> signals)
        {
            ...
            foreach (var typeSymbol in signals)
            {
                ...
                sb.AppendLine("        {");
                sb.AppendLine("            get => " + INJECTION_FIELD_NAMESPACE + ".Locator.Instance.SignalLocator.GetSignal<" + fullTypeName + ">();");
                sb.AppendLine("        }");
            }
